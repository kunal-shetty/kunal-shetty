...
<img src="https://skillicons.dev/icons?i=cpp,java,python,js,ts,mysql,react,nextjs,nodejs,tailwind,postgres,mongodb,supabase,docker,aws,netlify,vercel&theme=dark"&perline=10></img>
  </a>
</p>
---
...
- **Layoutrix** — Design-to-code generator that turns UI concepts into structured, developer-friendly Next.js projects  
  → https://layoutrix.netlify.app  

- **SolvAI** — Smart AI-powered calculator with advanced mathematical capabilities  
  → https://solvai.live  

- **AQI Monitoring** — Real-time air quality monitoring with health-based insights  
